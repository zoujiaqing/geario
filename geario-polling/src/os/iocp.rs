...
pub trait PollerIocpExt: PollerSealed {
    ...
    ///
    /// ```rust
    /// use geario_polling::{Poller, Event, Events};
    /// use geario_polling::os::iocp::{CompletionPacket, PollerIocpExt};
    ///
    /// use std::thread;
    /// use std::sync::Arc;
    ...
    ///
    /// ```no_run
    /// use geario_polling::{Poller, Event, Events, PollMode};
    /// use geario_polling::os::iocp::PollerIocpExt;
    ///
