...
// Disabled: calls BytesMut::split_off, which this version of the buffer API
// does not have. The benchmark is stale rather than the buffer being wrong;
// restoring it means deciding what "shared" should mean here, which is a
// question about the benchmark, not about the buffers.
// #[bench]
