...
use crate::net::channel::{self, Receiver};
...
/// geario reactor based on compio runtime
pub struct Reactor;

impl crate::rt::Driver for Reactor {
    fn run(&self, _: &crate::rt::Runtime) -> std::io::Result<()> {
        panic!("Not supported")
    }

    fn handle(&self) -> Box<dyn crate::rt::Notify> {
        panic!("Not supported")
    }
...
impl crate::net::Reactor for Reactor {
