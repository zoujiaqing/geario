...
use crate::service::dev::{Apply, ApplyCtx};
use crate::service::{IntoServiceFactory, Service, ServiceChainFactory, ServiceFactory};
...
pub trait Middleware<S, St, Cfg> {
    ...
    {
        crate::service::factory(ApplyMiddleware::new(self, factory))
    }
}
...
mod tests {
    ...
    use super::*;
    use crate::service::{Ctx, Pipeline, factory, fn_service};
