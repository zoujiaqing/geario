...
use crate::service::{Ctx, IntoService, IntoServiceFactory, Service, ServiceFactory};
...
/// ```rust
/// use std::io;
/// use geario::service::{factory, fn_factory, fn_service, Pipeline, Service, ServiceFactory};
///
...
/// ```rust
/// use std::io;
/// use geario::service::{factory_no_st, fn_factory_with_config, fn_service, Pipeline, Service, ServiceFactory};
///
/// #[geario::main]
/// async fn main() -> io::Result<()> {
...
mod tests {
    ...
    use super::*;
    use crate::service::{Pipeline, factory_no_st};
