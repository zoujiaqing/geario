...
#[deprecated]
pub use crate::service::chain::svc;
...
/// #
/// # use geario::service::{Service, Ctx};
///
/// struct MyService;
///
...
pub mod dev {
    pub use crate::service::and_then::{AndThen, AndThenFactory};
    pub use crate::service::apply::{Apply, ApplyCtx, ApplyFactory};
    pub use crate::service::chain::{ServiceChain, ServiceChainFactory};
    pub use crate::service::fn_ready::FnReadiness;
