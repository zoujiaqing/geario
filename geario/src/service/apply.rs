...
use crate::service::ctx::{Ctx, WaitersRef};
use crate::service::{IntoService, IntoServiceFactory, Service, ServiceFactory};
use crate::service::{ServiceChain, ServiceChainFactory};
...
where
    ...
    Err: From<S::Error>,
{
    crate::service::service(Apply::new(service.into_service(), f))
}
...
where
    ...
    Err: From<Sf::Error>,
{
    crate::service::factory(ApplyFactory::new(service.into_factory(), f))
}
...
mod tests {
    ...
    use super::*;
    use crate::service::{factory, fn_factory, service};
