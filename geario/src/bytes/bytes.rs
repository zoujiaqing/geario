...
use crate::bytes::{Buf, BytesMut, buf::IntoIter, debug, storage::INLINE_CAP, storage::Storage};
...
impl Bytes {
    ...
    #[inline]
    #[doc(hidden)]
    pub fn info(&self) -> crate::bytes::info::Info {
        self.storage.info()
    }
}
...
impl From<crate::bytes::ByteString> for Bytes {
    fn from(src: crate::bytes::ByteString) -> Bytes {
        src.into_bytes()
    }
}
