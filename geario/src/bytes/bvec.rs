...
use crate::bytes::{Buf, BufMut, Bytes, buf::IntoIter, buf::UninitSlice, stvec::StorageVec};
...
impl BytesMut {
    ...
    pub fn new() -> BytesMut {
        BytesMut {
            storage: StorageVec::with_capacity(crate::bytes::storage::MIN_CAPACITY),
        }
    }
...
impl fmt::Debug for BytesMut {
    fn fmt(&self, fmt: &mut fmt::Formatter<'_>) -> fmt::Result {
        fmt::Debug::fmt(&crate::bytes::debug::BsDebug(self.storage.as_ref()), fmt)
    }
}
