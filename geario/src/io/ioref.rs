...
use crate::bytes::{BytePage, BytePages, BytesMut};
use crate::codec::{Decoder, Encoder};
use crate::service::cfg::SharedCfg;
use crate::util::time::Seconds;

use crate::io::ops::{Id, Iops, TimerHandle};
use crate::io::{Decoded, Filter, FilterBuf, Flags, IoConfig, IoContext, IoRef, types};
...
impl IoRef {
    ...
    pub fn on_disconnect(&self) -> crate::io::OnDisconnect {
        crate::io::OnDisconnect::new(self.0.clone())
    }

    #[doc(hidden)]
    /// Register filter callbacks
    pub fn register_filter_callbacks<F: crate::io::IoCallbacks + 'static>(&self, f: F) {
    ...
    where
        F: FnOnce(&dyn crate::io::IoCallbacks),
    {
...
mod tests {
    ...
    use super::*;
    use crate::io::{FilterCtx, Io, testing::IoTest};
    ...
    impl<F: Filter> Filter for Counter<F> {
        ...
        crate::io::forward_ready!(layer);
        crate::io::forward_query!(layer);
        crate::io::forward_shutdown!(layer);
    }
