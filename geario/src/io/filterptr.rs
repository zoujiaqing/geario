...
use crate::io::{Filter, FilterLayer, Layer, Sealed, filter::NullFilter};
...
mod tests {
    ...
    use super::*;
    use crate::io::{Base, FilterBuf, Handle, Io, IoContext, IoStream, testing::IoTest};
    ...
    async fn drop_filter() {
        ...
        let io2 = io.take();
        let mut io3: crate::io::IoBoxed = io2.into();
        let io4 = io3.take();
