...
use crate::rt::{driver::Driver, driver::Notify, driver::PollResult, handle::JoinHandle};

scoped_tls::scoped_thread_local!(static CURRENT_RUNTIME: Runtime);

#[derive(Debug)]
/// The async runtime for geario.
///
...
impl Runtime {
    ...
    pub fn block_on<F: Future>(&self, future: F, driver: &dyn Driver) -> F::Output {
        ...
        CURRENT_RUNTIME.set(self, || {
            ...
            crate::error::set_backtrace_start_alt("src/raw.rs", 0);
